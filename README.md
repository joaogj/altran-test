## Globoplay - Teste Altran

Página desenvolvida para teste de conhecimento no processo seletivo da equipe Altran.
...
## Instalação
  **1 - Clonar o projeto**
  ```
  git clone https://github.com/joaogj/altran-test.git
  ```
